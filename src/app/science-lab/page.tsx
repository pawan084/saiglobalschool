...
export const metadata = {
  title: "Science Lab",
  description: "Hands-on experiments, structured enquiry and report writing in the practical lab notebook — SSSGS Science Lab for primary and secondary school children, Singapore.",
