    ...
    >
      <ContentSection flush>
        <div className="mx-auto w-full">
          ...
          />
          <div className="mx-auto mt-8 max-w-3xl space-y-4 text-center text-[15.5px] leading-relaxed text-slate-700">
            <p>
      ...
      <section className="pt-4 -mb-6 lg:-mb-8">
        <div className="rounded-lg border border-[var(--brand-rule)] bg-[var(--brand-cream)]/55 p-5 lg:flex lg:items-center lg:justify-between lg:gap-6">
          <div>
            <div className="news-eyebrow mb-1.5">Proof points</div>
            <h2 className="news-headline text-[20px] font-extrabold leading-tight lg:text-[24px]">
              Related pages parents often check
            </h2>
          </div>
