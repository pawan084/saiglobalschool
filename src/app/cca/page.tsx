...
export const metadata = {
  ...
  description: "Co-curricular activities at SSSGS Singapore — music, visual and performing arts, sport, debate, speech and service clubs across primary and secondary school.",
