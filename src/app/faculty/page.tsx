...
export const metadata = {
  title: "Faculty",
  description: "Meet the experienced, values-led educators behind small-group teaching at Sri Sathya Sai Global School, Singapore — primary and secondary school faculty.",
