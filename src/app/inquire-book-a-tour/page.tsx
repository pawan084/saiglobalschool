      ...
      <ContentSection flush>
        ...
        <FormCard
          ...
          fields={[
            ...
            { name: "preferred_contact", label: "Preferred contact method", type: "select", required: true,
            ...
            { name: "current_school", label: "Current school" },
            { name: "current_curriculum", label: "Current curriculum", type: "select",
              options: ["CBSE", "ICSE", "Cambridge", "IB", "Singapore local", "Other"] },
            { name: "joining_timeline", label: "Expected joining timeline", type: "select",
              options: ["Immediately", "This term", "Next term", "Next academic year", "Just exploring"] },
            { name: "tour_type", label: "Preferred visit type", type: "select",
              options: ["Campus tour", "Phone call first", "Online meeting", "Open House"] },
