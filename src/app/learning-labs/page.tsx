...
const labs = [
  ...
  { title: "ICT Lab — digital literacy from Grade 1", href: "/ict-lab", eyebrow: "ICT", image: "/img/7621-2.jpg", lead: "Typing, online safety, productivity tools and computational thinking." },
];
